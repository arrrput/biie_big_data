                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 m-auto">
                        <div class="authentication-form mx-auto">
                            ...
                            @csrf
                                ...
                                {{-- <lottie-player class="ml-50" src="https://assets8.lottiefiles.com/packages/lf20_rrw4rw07.json"  background="transparent"  speed="1"  style="width: 150px; height: 150px;"  loop  autoplay></lottie-player>
                                <h5 class="text-center">Goods in out</h5> --}}
                            </form>
                        </div>
                    </div>
                </div>
