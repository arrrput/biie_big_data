                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <select class="custom-select rounded-1" placeholder="" id="type_request" name="type_request" disabled>
                                        <option disable>-- Select -- </option>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <select class="custom-select rounded-1" placeholder="" id="jenis_dukungan" name="jenis_dukungan" disabled>
                                        <option disable>-- Select -- </option>
                        ...
                        <div class="form-group">                            
                            <div class="checkbox-list ml-3">
                                <label class="checkbox-success">
                                    <input type="checkbox" name="email_req" id="email_req" value="1" onclick="showEmail()" value="1" disabled/>
                                ...
                                <label class="checkbox-success">
                                    <input type="checkbox" name="user_req" id="user_req" value="1" onclick="showUser()" disabled/>
                                    <span></span>{{__(' Username komputer, Nama user sebutkan')}}
                                </label>

                                <label class="checkbox-success">
                                    <input type="checkbox" name="internet_req" id="internet_req" value="1" disabled/>
                                    <span></span>{{__(' Akses Internet / Jaringan')}}
                                </label>

                                <label class="checkbox-success">
                                    <input type="checkbox" name="backup_req" id="backup_req" value="1" disabled/>
                                    <span></span>{{__(' Backup Data (Seminggu sekali)')}}
                                </label>

                                <label class="checkbox-success">
                                    <input type="checkbox" name="download_req" id="download_req" value="1" onclick="showDownload()" disabled/>
                                    <span></span>{{__(' Download/Install Aplikasi, Sebutkan aplikasinya')}}
                                </label>

                                <label class="checkbox-success">
                                    <input type="checkbox" name="perangkat_komputer_req" id="perangkat_komputer_req" value="1" onclick="showPerangkat()" disabled/>
                                    <span></span>{{__(' Perangkat komputer, sebutkan')}}
                                </label>

                                <label class="checkbox-success">
                                    <input type="checkbox" name="desain_req" id="desain_req" value="1" disabled/>
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group" style="display: none;" id="show_email">
                            <div class="input-group" >
                                <input type="text" id="email_desc" name="email_desc" class="form-control" placeholder="{{__('Email')}}" aria-describedby="basic-addon2" disabled >
                        ...
                        <div class="form-group" style="display: none;" id="show_username">
                            <input type="text" name="username_desc" id="username_desc" class="form-control" placeholder="Username Komputer" disabled/>
                        </div>

                        <div class="form-group" style="display: none;" id="show_download">
                            <input type="text" name="download_desc" id="download_desc" class="form-control" placeholder="Sebutkan nama aplikasi" disabled />
                        </div>

                        <div class="form-group" style="display: none;" id="show_perangkat">
                            <input type="text" name="download_perangkat" id="download_perangkat" class="form-control" placeholder="Sebutkan perangkat" disabled />
                        </div>
                    </div>

                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <textarea name="deskripsi" id="deskripsi" class="form-control " cols="4" placeholder="Deskripsi permintaan/ perbaikan/ pengembalian" disabled></textarea>
                        </div>
                    </div>
...
<script>
    ...
    table_list = $('#table_list').DataTable({
        ...
        $.ajax({
        type:'POST',
        url: "{{ route('gmo.it_request.update_progress')}}",
        data: formData,
        cache:false,
        contentType: false,
        processData: false,
