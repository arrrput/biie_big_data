                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>{{__('External Document')}}</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
                            ...
                            <div class="col-lg-12 layout-spacing">
                                ...
                                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                                    <div class="widget-content widget-content-area br-6">
                                        <h4 class="table-header"><i class="lab la-medapps text-success"></i> {{__('External Document IMS')}}</h4>
                                        <div class="table-responsive mb-4">
                                            ...
                                            <button class="btn btn-primary btn-sm mb-2 mt-2" onclick="clearField()" data-toggle="modal" data-target="#master_add">
                                                <i class="las la-plus sidemenu-right-icon"></i>Add Document
                                            </button>
                                            @endcan
...
<script>
    ...
    $('#master_doc_add').submit(function(e) {
        ...
        $.ajax({
        type:'POST',
        url: "{{ route('ims.external_doc.add')}}",
        data: formData,
        cache:false,
        contentType: false,
        processData: false,
    ...
    function editMaster(id){
        $.ajax({
        type:"GET",
        url: "{{ URL::to('/') }}/ims/external-doc/show/"+id,
        dataType: 'json',
   ...
   function deleteMaster(id){
            if (confirm("Delete this request?") == true) {
                ...
                $.ajax({
                    type:"DELETE",
                    url: "{{ URL::to('/') }}/ims/external-doc/delete/"+id,
                    data: { id: id},
                    // dataType: 'json',
                    success: function(res){
